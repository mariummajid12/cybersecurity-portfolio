...
def eval_and_rank_dcs(x_tuples_df: pd.DataFrame,
    ...
    col_to_weight = {
        'tuple_violation_rate_per_dc__below_1_pct': 6.0,  # Emphasize strict constraints more
        'tuple_violation_rate_per_dc__below_5_pct': 2.0,
        'tuple_violation_rate_per_dc__below_10_pct': 1.5,
        'pairs_violation_rate_per_dc': -2.0,  # Penalize higher violation rates more
        'tuple_violation_rate_per_dc': -2.0,
        'succinctness_per_dc': 2.0,  # Emphasize simplicity slightly more
        'coverage_per_dc': 5.0,  # Boost coverage weight
    }
